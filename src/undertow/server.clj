...
(extend-type Undertow
  CanBeStarted (start [instance] (doto instance .start))
  CanBeStopped (stop [instance] (.stop instance)))
...
(types/define-option :xnio/worker-io-threads
...
(types/define-option :xnio/worker-task-core-threads
...
(types/define-option :undertow/max-header-size
...
(types/define-option :undertow/max-entity-size
...
;; requests.
(types/define-option :undertow/multipart-max-entity-size
...
;; Defaults to 1000.
(types/define-option :undertow/max-parameters
...
;; to 200.
(types/define-option :undertow/max-headers
...
;; to true.
(types/define-option :undertow/decode-url
...
;; disabled by default.
(types/define-option :undertow/allow-encoded-slash
...
(types/define-option :undertow/allow-equals-in-cookie-value
...
(types/define-option :undertow/always-set-date
...
(types/define-option :undertow/always-set-keep-alive
...
(types/define-option :undertow/max-buffered-request-size
...
(types/define-option :undertow/record-request-start-time
...
(types/define-option :undertow/idle-timeout
...
(types/define-option :undertow/request-parse-timeout
...
(types/define-option :undertow/no-request-timeout
...
;; instead of HTTP/1.1.
(types/define-option :undertow/enable-http2
...
(types/define-option :undertow/http2-settings-header-table-size
                     UndertowOptions/HTTP2_SETTINGS_HEADER_TABLE_SIZE int)

;; If server push is enabled for this connection.
(types/define-option :undertow/http2-settings-enable-push
...
;; time.
(types/define-option :undertow/http2-settings-max-concurrent-streams
                     UndertowOptions/HTTP2_SETTINGS_MAX_CONCURRENT_STREAMS int)

;; The initial flow control window size.
(types/define-option :undertow/http2-settings-initial-window-size
                     UndertowOptions/HTTP2_SETTINGS_INITIAL_WINDOW_SIZE int)

;; The maximum frame size.
(types/define-option :undertow/http2-settings-max-frame-size
